...
var TweetList = function (_Component) {
  ...
  _createClass(TweetList, [{
    ...
    value: function render() {
      ...
      var cells = this.props.ids.map(function (x, counter) {
        return _react2.default.createElement(_Tweet2.default, { id: x, key: counter });
      });
...
exports.default = (0, _reactRedux.connect)(mapStateToProps, null)(TweetList);